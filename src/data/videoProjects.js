...
export const aiFilmProjects = [
  {
    ...
    image: `${import.meta.env.BASE_URL}images/ai_film_1.webp`,
  ...
  },
  {
    ...
    duration: "",
    youtubeId: "",
    image: `${import.meta.env.BASE_URL}images/ai_film_2.webp`,
    accent: "text-white/70",
    badge: "AI Film Production",
    point: "",
    description:
...
export const filmProjects = [
  {
    ...
    image: `${import.meta.env.BASE_URL}images/project_1.webp`,
    accent: "text-white/0",
...

  {
    ...
    image: `${import.meta.env.BASE_URL}images/project_2.webp`,
    accent: "text-white/0",
    badge: "Film Production",
    point: "",
    description:
...

  {
    ...
    image: `${import.meta.env.BASE_URL}images/project_3.webp`,
    accent: "text-white/0",
    badge: "Film Production",
    point: "",
    description:
...

  {
    ...
    image: `${import.meta.env.BASE_URL}images/project_4.webp`,
    accent: "text-white/0",
    badge: "Film Production",
    point: "",
    description:
