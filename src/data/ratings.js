...
// image: /images 폴더에 실제 스틸컷을 넣고 경로만 바꿔주세요. (없으면 placeholder 그라디언트 사용)
...
export const ratings = [
  {
    ...
    infoImage: "/images/3d_info_1.webp",
...

  {
    ...
    program: "3Ds MAX",
    image: "/images/3d_2.webp",
    infoImage: "/images/3d_info_2.webp",
    gradient: "from-stone-700 via-amber-800 to-orange-900",
    description:
...

  {
    ...
    program: "3Ds MAX",
    image: "/images/3d_3.webp",
    infoImage: "/images/3d_info_3.webp",
    gradient: "from-stone-700 via-amber-800 to-orange-900",
    description:
